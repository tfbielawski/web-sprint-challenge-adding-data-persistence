...
1. Explain the difference between Relational Databases and SQL.
   -SQL is the query language used to manage relational databases. Relational Databases are databases that store information in tables that can have a relation to other tables via primary and oreign key.
2. Why do tables need a Primary Key?
   -to identify columns in the table
